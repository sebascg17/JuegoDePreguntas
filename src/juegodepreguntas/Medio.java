...
public class Medio extends javax.swing.JFrame {
    ...
    static String textoBaseDePreguntas = "¿Cuál es el país con más habitantes del mundo?\tChina\tIndia\tJapón\tRusia"
            ...
            +"\n"
            +"¿Cuál fue la primera civilización humana?\tLa civilización Sumeria\tLa civilización Romana\tLa civilización Griega\tLa civilización Egipcia"
            +"\n"
            +"¿Cuántos años duró la Primera Guerra Mundial?\t4 años\t3 años\t5 años\t6 años";
    
    //DECLARACION DE VARIABLES
    static String[] renglones2 = textoBaseDePreguntas.split("\n");
    static int cantidadDePreguntas = renglones2.length;    
    static String[][] baseDePreguntas2 = new String[cantidadDePreguntas][5];    
    ...
    public void escogerPregunta(int n){
        preguntaEscogida = baseDePreguntas2[n];
